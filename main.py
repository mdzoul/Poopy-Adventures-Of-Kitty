...
print("Good morning, Kitty. You have just woken up from your owner's bed. It was a good long nap. You feel a little "
      "disoriented but now there is a sense of urgency rising within you.\n")
print("\33[1;4mYour mission is to poop.\33[0m\n")

# Door/Stay
door_stay = input("You look around you and you see the door.\n\nDo you choose to go to the \33[32m[door]\33[0m or "
                  "\33[32m[stay]\33[0m?\n").lower()

if door_stay == "door":
    print("---\nYou manage to fumble towards the door and see a fork in the hallway.")

    # Master-bedroom/Living room/Guest room - Start
    print(
        "\nYou know this house like the back of your paw.\n\nThe living room is \33[32m[straight]\33[0m ahead.\nThe "
        "master bedroom is on your \33[32m[left]\33[0m.\nThe guest bedroom is on your \33[32m[right]\33[0m.")
    ...
    if mlg_room == "straight":
        ...
        if walk_eat == "walk":
            ...
            if towards_around == "around":
                ...
                print(
                    ...
                    "barely holding on anymore.\nYou are trying to keep it together as you tell yourself that the "
                    "litter box is at the end of the kitchen after the guest toilet.\nYou don't know if you are going "
                    "to make it.")
                box_toilet = input(
                    "\nAs you are about to run past the \33[32m[guest toilet]\33[0m towards the \33[32m[litter "
                    "box]\33[0m at the end of the kitchen, you make the daring decision to use the:\n").lower()

                if box_toilet == "guest toilet":
                    print(
                        "---\nYou see that the guest toilet doors are closed.\nYou have to think fast whether you "
                        "want to \33[32m[meow]\33[0m as loud as you can to let yourself in or \33[32m[push]\33[0m the "
                        "doors with all your might.")
                    ...
                    if push_meow == "push":
                        print(
                            "---\nYou stand up on your hind legs and push the doors open with your body weight in one "
                            "go.\n\nThe toilet is empty!\n\nYou climb onto the edge of the toilet seat and finally "
                            "flush all that stress and tension away.")
                        print("\n\33[1;32mNicely Done, Kitty! Good job!\33[0m")

                    elif push_meow == "meow":
                        print(
                            "---\nYou made a mistake.\n\nThe moment you squeezed that tiny diaphragm to let out the "
                            "loudest meow you can possibly muster, you also contracted your abdominal muscles a "
                            "little too hard.")
                        print(
                            "\nYour fierce meow becomes a meow of embarrassment as you ask your humans to help you "
                ...
                print(
                    "---\nYou try to stealthily walk past your human, in hopes that she is too engrossed in her phone "
                    "to not notice you.\nUnfortunately, in the moment that you do, she looked away from her phone and "
            ...
            print(
                "---\nYou indulge in the crunchy and sweet taste of your food.\nYou forget about the world and your "
                "problems as you take another bite, and then another.")
            print(
        ...
        print(
            "---\nYou rush to the master bedroom toilet.\nYou push on the toilet door in anticipated relief only to "
            "find out that one of your humans is occupying it\nToo late.\nYour anticipated relief just became an "
            "accidental one.")
        print("\n\33[31mGame Over.\33[0m")
    elif mlg_room == "right":
        print(
            "---\nYou decide to take a detour and enter the guest bedroom for some reason.\nAs you enter the bedroom, "
            "you trip on the door stopper.\nYou wander about in the guest bedroom not realising that the door is "
            "slowly closing behind you.")
        print("\nSLAM! The door shut close.")
        print("\n\33[31mGame Over.\33[0m")

    else:
        print("\n\33[31m[Invalid input. Please rerun.]\33[0m")
    # Master-bedroom/Living room/Guest room - End

elif door_stay == "stay":
    print(
        "---\nYou decide to close your eyes and nap a bit more.\nYou wake up to a pile of your own poop on your "
